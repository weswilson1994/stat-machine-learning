...
-   A sentence on ethical considerations -- something like this is for exploratory purposes only, there is a big issue with operationalizing predictive models into police interactions.
-   A sentence on each major finding (I have already added mine).
